...
var kirk7_key02 = new Uint8Array([0xB8, 0x13, 0xC3, 0x5E, 0xC6, 0x44, 0x41, 0xE3, 0xDC, 0x3C, 0x16, 0xF5, 0xB4, 0x5E, 0x64, 0x84 ]); // New from PS3
...
var kirk7_key07 = new Uint8Array([0x76, 0x36, 0x8B, 0x43, 0x8F, 0x77, 0xD8, 0x7E, 0xFE, 0x5F, 0xB6, 0x11, 0x59, 0x39, 0x88, 0x5C ]); // New from PS3
...
var kirk7_key44 = new Uint8Array([0x7D, 0xF4, 0x92, 0x65, 0xE3, 0xFA, 0xD6, 0x78, 0xD6, 0xFE, 0x78, 0xAD, 0xBB, 0x3D, 0xFB, 0x63 ]);  // New from PS3
var kirk7_key4B = new Uint8Array([0x0C, 0xFD, 0x67, 0x9A, 0xF9, 0xB4, 0x72, 0x4F, 0xD7, 0x8D, 0xD6, 0xE9, 0x96, 0x42, 0x28, 0x8B ]); //1.xx game eboot.bin
...
function kirk_4_7_get_key(key_type: number)
{
	switch (key_type) {
		...
		default: throw(new Error("Unsupported key '" + key_type + "'"));
	}
}
