module hle.modules {
    export class ModuleMgrForUser {
		...
		sceKernelSelfStopUnloadModule = createNativeFunction(0xD675EBB8, 150, 'uint', 'HleThread/int/int/int', this, (thread: hle.Thread, unknown: number, argsize: number, argp: number) => {
