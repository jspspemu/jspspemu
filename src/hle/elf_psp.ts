module hle.elf {
	import ElfLoader = format.elf.ElfLoader;
	import ElfSectionHeader = format.elf.ElfSectionHeader;
	import ElfSectionHeaderFlags = format.elf.ElfSectionHeaderFlags;
	import ElfSectionHeaderType = format.elf.ElfSectionHeaderType;
	import ElfReloc = format.elf.ElfReloc;
	import ElfRelocType = format.elf.ElfRelocType;
	import ElfProgramHeaderType = format.elf.ElfProgramHeaderType;
	import ElfDwarfLoader = format.elf.dwarf.ElfDwarfLoader;
